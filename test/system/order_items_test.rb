...
class OrderItemsTest < ApplicationSystemTestCase
  ...
  test "creating a Order item" do
    ...
    fill_in "Max quantity", with: @order_item.max_quantity
    fill_in "Min quantity", with: @order_item.min_quantity
    fill_in "Shared order", with: @order_item.shared_order
    fill_in "User", with: @order_item.user
